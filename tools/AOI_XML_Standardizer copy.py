...
def main():
    ...
    if uploaded_file:
        ...
        tabs = st.tabs(["Parameters Editor", "Local Tags Editor", "AOI Identity Editor", "Download Updated File"])
        ...
        with tabs[3]:  # Download Updated File Tab
            ...
            if has_param_changes or has_local_changes or has_aoi_changes:
                st.markdown("**Proposed Changes:**")
